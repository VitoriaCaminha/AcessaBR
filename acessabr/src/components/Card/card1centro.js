...
import centrohistorico from '../../images/centrohistorico.jpeg'
  ...
  return(
      <div className="card__container">
          <div className="card__image">
            <img 
              src={centrohistorico}
              alt='Centro Histórico de Olinda'
              title='Centro Histórico de Olinda'/>
          </div>
          <div className="card__content">
              <h3>Centro Histórico de Olinda</h3>
              ...
              <p>Centro da cidade histórica de Olinda, onde há várias construções barrocas em estilo português.</p>
