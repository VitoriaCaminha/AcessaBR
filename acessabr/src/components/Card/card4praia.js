...
import mirabilandia from '../../images/mirabilandia.jpg'
  ...
  return(
      <div className="card__container">
          <div className="card__image">
            <img 
              src={mirabilandia}
              alt='Mirabilândia Parque de Diversoes'
              title='Mirabilândia Parque de Diversoes'/>
          </div>
          <div className="card__content">
              <h3>Mirabilândia Parque</h3>
              ...
              <p>Parque temático com diversas atrações, como montanhas-russas e brinquedos para crianças</p>
