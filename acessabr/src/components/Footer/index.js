  ...
  return (
    <footer className='footer'>
      ...
      <div className='footer__section footer__section--second'>
        <div className='footer__container'>
          <p>
            <strong>Projeto Elaborado durante a RDW <a href="https://ebaconline.com.br" target="_blank" rel="noreferrer">E.B.A.C</a> 2021</strong>
            <small>
            Projetado por <a href='https://github.com/cavalcantemmarcelo' target="_blank" rel="noreferrer">Marcelo Cavalcante</a> e <a href='https://github.com/mja-maia/' target="_blank" rel="noreferrer">Miguel Maia</a>, desenvolvido por <a href='https://github.com/VitoriaCaminha' target="_blank" rel='noreferrer'>Vitória Caminha</a> 
            </small>
          </p>
